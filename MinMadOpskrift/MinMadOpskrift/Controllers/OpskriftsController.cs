...
{
    [Route("api/Opskrift")]
    public class OpskriftsController : Controller
    {
        private MinMadOpskriftEntities db = new MinMadOpskriftEntities();

        // GET: Opskrifts
        [HttpGet, Route("api/Opskrift")]
